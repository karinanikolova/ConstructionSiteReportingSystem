...
namespace ConstructionSiteReportingSystem.Core.Services.Contracts
{
    ...
    {
        Task<TaskQueryServiceModel> GetAllUserTasksAsync(string userId, bool isAdmin, string? searchStatus = null, string? searchTerm = null, DateSorting dateSorting = DateSorting.Newest, int currentPage = 1, int tasksPerPage = 1);
